...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-primary">
	  ...
	  <div class="collapse navbar-collapse" id="navbarNavDropdown">
	    <ul class="navbar-nav">
	      <li class="nav-item">
	        <a class="nav-link" href="ualleventlist.php">Event list</a>
	      </li>
	      <li class="nav-item">
	        <a class="nav-link" href="umyevents.php">My events</a>
	      </li>
	      <li class="nav-item active">
	        <a class="nav-link" href="uoptions.php">Options<span class="sr-only">(current)</span></a>
	      </li>
	    </ul>
	  </div>
	</nav>
